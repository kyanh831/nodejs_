        ...
        return (
            <>
                <section className="breadcrumb-bg">
                    <div className="theme-container container ">
                        <div className="site-breadcumb white-clr">
                            <h2 className="section-title"> <strong className="clr-txt">naturix </strong> <span className="light-font">About </span> </h2>
                ...
                <section className="short-about sec-space light-bg">
                    ...
                    <img alt="" src="https://jthemes.net/themes/f-html/naturix-html/assets/img/extra/sec-img-1.png" className="left-top-img" />
                    <img alt="" src="https://jthemes.net/themes/f-html/naturix-html/assets/img/extra/sec-img-3.png" className="center-bg-img" />
                    <img alt="" src="https://jthemes.net/themes/f-html/naturix-html/assets/img/extra/sec-img-4.png" className="left-bottom-img" />

                    <div className="container rel-div">
                        <div className="title-wrap pt-15">
                            <h4 className="fsz-20"> <strong>naturix</strong> <span className="light-font">  organic farmfood since 1990 </span> </h4>
                            <h2 className="fsz-50 over-txt-title">
                                <span className="light-font"> WE DO <span className="over-txt light-bg">100% ORGANIC GUARANTEE</span> </span>
                                <strong>HEALTHY</strong>
                            </h2>
                            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.  Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud ullamcorper . </p>
                        </div>

                        <div className="about-wrap">
                            <img className="logo-img" alt="" src="https://jthemes.net/themes/f-html/naturix-html/assets/img/extra/sign-1.png" />
                            <h4 className=""> <strong>Gabriel</strong> <span className="light-font"> Johnson </span> </h4>
                            <h5 className="clr-txt sub-title-sm">NATURIX OWNER</h5>
                            <img className="logo-img" alt="" src="https://jthemes.net/themes/f-html/naturix-html/assets/img/extra/about-1.png" />
                    ...
                    <div className="row sec-space-top"> 
                            ...
                            <div className="row"> 
                                <div className="col-sm-4"> 
                                    <div className="organic-prod">
                                        <img src="https://jthemes.net/themes/f-html/naturix-html/assets/img/extra/organic-1.png" alt=""/>
                                        <span className="divider"></span>
                                        <h3 className="title-1"> <a href="#"> <span className="light-font">organic </span> <strong> fruits</strong> </a> </h3>
                                        <i className="clr-txt font-2"> 52 items </i>
                                    </div>
                                </div>
                                <div className="col-sm-4"> 
                                    <div className="organic-prod">
                                        <img src="https://jthemes.net/themes/f-html/naturix-html/assets/img/extra/organic-2.png" alt=""/>
                                        <span className="divider"></span>
                                        <h3 className="title-1"> <a href="#"> <span className="light-font">fresh </span> <strong> vegetables</strong> </a> </h3>
                                        <i className="clr-txt font-2"> 35 items </i>
                                    </div>
                                </div>
                                <div className="col-sm-4"> 
                                    <div className="organic-prod">
                                        <img src="https://jthemes.net/themes/f-html/naturix-html/assets/img/extra/organic-3.png" alt=""/>
                                        <span className="divider"></span>
                                        <h3 className="title-1"> <a href="#"> <span className="light-font">organic </span> <strong> breads</strong> </a> </h3>
                        ...
                        <div className="col-lg-6 col-sm-12"> 
                            <div className="organic-prod-info">
                                ...
                                <h2 className="section-title ptb-15"> <span className="light-font">220+ </span> <strong>fruits, vegetables </strong> <span className="light-font"> &amp; </span> <strong> lot more</strong> </h2>
                                <p className="fsz-16">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. </p>
                            </div>
                        </div>
                    </div>
                    <div className="row sec-space-top"> 
                        <div className="col-lg-6 col-sm-12"> 
                            <div className="organic-prod-info">
                                <h4 className="sub-title">  FRESH FROM OUR FARM </h4>
                                <h2 className="section-title ptb-15"> <span className="light-font">115+ </span> <strong>organic juices </strong> <span className="light-font"> and </span> <strong> organic tea</strong> </h2>
                                <p className="fsz-16">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. </p>
                            </div>
                        </div>
                        <div className="col-lg-6 col-sm-12"> 
                            <div className="row"> 
                                <div className="col-sm-4"> 
                                    <div className="organic-prod">
                                        <img src="https://jthemes.net/themes/f-html/naturix-html/assets/img/extra/organic-4.png" alt=""/>
                                        <span className="divider"></span>
                                        <h3 className="title-1"> <a href="#"> <span className="light-font">organic </span> <strong> juices</strong> </a> </h3>
                                        <i className="clr-txt font-2"> 26 items </i>
                                    </div>
                                </div>
                                <div className="col-sm-4"> 
                                    <div className="organic-prod">
                                        <img src="https://jthemes.net/themes/f-html/naturix-html/assets/img/extra/organic-5.png" alt=""/>
                                        <span className="divider"></span>
                                        <h3 className="title-1"> <a href="#"> <span className="light-font">dried </span> <strong> juices</strong> </a> </h3>
                                        <i className="clr-txt font-2"> 31 items </i>
                                    </div>
                                </div>
                                <div className="col-sm-4"> 
                                    <div className="organic-prod">
                                        <img src="https://jthemes.net/themes/f-html/naturix-html/assets/img/extra/organic-6.png" alt=""/>
                                        <span className="divider"></span>
                                        <h3 className="title-1"> <a href="#"> <span className="light-font">organic </span> <strong> tea</strong> </a> </h3>
